        ...
        <div class="row">
          ...
          <div class="col-12 col-lg-6 col-md-6 col-sm-12">
            ...
            <select
              name="airports"
              id="airports"
              class="form-select list1"
              v-model="flight_book.from"
          ...
          <div class="col-12 col-lg-6 col-md-6 col-sm-12">
            ...
            <select
              name="airports"
              id="airports"
              class="form-select list2"
              v-model="flight_book.to"
              @change="onChange($event.target.value)"
            >
              <option selected disabled>Select Option</option>
          ...
          <div class="col-12 col-lg-6 col-md-6 col-sm-12">
            ...
            <input
              type="date"
              class="form-select"
              v-model="flight_book.departure"
            />
          </div>
          <div
            class="col-12 col-lg-6 col-md-6 col-sm-12"
            v-if="flight_book.type != 'oneway'"
          >
            <label for="from">Return Date: </label>
            <input
              type="date"
              class="form-select"
              v-model="flight_book.return"
            />
          </div>
...
export default {
  ...
  methods: {
    bookFlight() {
      if (this.flight_book.type == "oneway") {
        this.filteredFlights = this.flights.filter(
          (flight) =>
            (flight.from == this.flight_book.from &&
      ...
      this.$store.dispatch("addFlight", this.filteredFlights);
    ...
    onChange() {
      ...
      // var list = this.list2.filter((v) => v.code == val);
      // this.list2[list];
